...
SECRET_KEY = 'django-insecure-=n-4jkrk#w-9weeb7i%zsl#7sgsis0-8h8a2&&$82#x_erg=ya'
...
CORS_ALLOW_ALL_ORIGINS = True  # For development only. For production, use CORS_ALLOWED_ORIGINS.
